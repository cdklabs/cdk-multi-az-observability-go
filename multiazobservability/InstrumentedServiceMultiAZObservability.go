...
import (
	...
	"github.com/cdklabs/cdk-multi-az-observability-go/multiazobservability/internal"
)
...
func (i *jsiiProxy_InstrumentedServiceMultiAZObservability) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
