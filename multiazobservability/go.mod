module github.com/cdklabs/cdk-multi-az-observability-go/multiazobservability
...
require (
	...
	github.com/cdklabs/cloud-assembly-schema-go/awscdkcloudassemblyschema/v53 v53.12.0 // indirect
)
