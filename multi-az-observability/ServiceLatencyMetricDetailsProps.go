...
// Experimental.
type ServiceLatencyMetricDetailsProps struct {
	...
	// Experimental.
	SuccessAlarmThreshold awscdk.Duration `field:"required" json:"successAlarmThreshold" yaml:"successAlarmThreshold"`
}
